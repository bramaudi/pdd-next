...
@if ($paginator->hasPages())
    ...
    @else   
    <li class="page-item">
        <a class="c-hand" href="#first" wire:key="first" wire:click="gotoPage(1)" rel="first">
            {!! __('pagination.first') !!}
        </a>
    </li>
    @endif
    ...
    <li class="page-item">
        <a class="c-hand" href="#last" wire:key="last" wire:click="gotoPage({{ $paginator->lastPage() }})" rel="last">
            {!! __('pagination.last') !!}
        </a>
    </li>
    @else
