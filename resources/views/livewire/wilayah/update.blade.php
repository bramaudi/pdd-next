<form wire:submit.prevent="submit">
    ...
    @else
        ...
        @if($kepala_dusun)
            <div class="mb-3">
                <label class="block font-semibold">Kepala Dusun Sebelumnya:</label>
                <input class="input" type="text" value="{{ $kepala_dusun['nik'] }} - {{ $kepala_dusun['nama'] }}" disabled>
            </div>
        @endif
        ...
        <div class="mb-3">
            <label for="inp-find-kepala" class="block font-semibold">
                ...
                <div wire:target="find" class="max-h-32 overflow-auto">
                    ...
                    @endforeach
                    @if(!count($list))
                    <span class="input-search--item error">
                        Tidak ditemukan
                    </span>
                    @endif
                </div>
